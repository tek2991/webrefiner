...
<head>
    ...
    <title>Webrefiner | Avant School Management System</title>
...
<body class="antialiased font-sans text-gray-800 bg-gray-200">
    <div id="site">
        <main>
            ...
            <div class="header w-full min-h-screen flex flex-col justify-between">
                <nav
                    ...
                    <div
                        ...
                        <a href="//localhost:1313/" class="no-underline"><img src="//localhost:1313/img/logo.svg"
                                alt="AWE.SOME Logo" class="h-12 py-1"></a>
                        <button id="menuBtn" class="hamburger block sm:hidden focus:outline-none" type="button"
                            onclick="navToggle();" aria-label="Show Menu"><span class="hamburger__top-bun"></span><span
                ...
                <div class="flex flex-col justify-center h-full py-12">
                    <div
                        class="self-center items-center flex flex-col sm:flex-row w-full md:w-5/6 xl:w-2/3 px-4 sm:px-0">
                        <div class="w-full text-center sm:text-left sm:w-1/2 py-12 sm:px-8">
                            <h1 class="tracking-wide text-pink-600 text-2xl mb-6">New Thing: <span
            ...
            <div id="features"
                class="w-full min-h-screen flex flex-col justify-center items-center bg-indigo-800 py-12">
                <div class="self-center text-center w-full sm:w-2/3 xl:w-1/2 px-4 sm:px:0">
                ...
                <div class="self-center text-center w-full xl:w-1/3 px-4 sm:px:0">
                    ...
                    <form class="w-full max-w-lg my-20 mx-auto" action="#" method="post" id="registration-form"
                        ...
                        <label class="block text-gray-200 text-left px-2 mt-4" for="gdpr_37169">
                            <input class="leading-tight" type="checkbox" id="gdpr_37169" name="gdpr[37169]" value="Y"
                                required>
