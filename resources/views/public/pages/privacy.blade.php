<x-site-layout>
    ...
    <div id="about" class="w-full min-h-screen flex flex-col justify-center items-center py-12">
        <div class="self-center text-center w-full sm:w-3/4 xl:w-2/3 px-4 sm:px:0">
            <h2 class="font-bold tracking-wider text-gray-800 text-4xl mb-4">Privacy Policy</h2>
            <div class="font-light text-black text-xl">

                <div class="text-left">
                    <p>At Webrefiner, accessible from webrefiner.com, one of our main priorities is the privacy of our
                        visitors. This Privacy Policy document contains types of information that is collected and
                        recorded by Webrefiner and how we use it.</p>
                    ...
                    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                        website with regards to the information that they shared and/or collect in Webrefiner. This
                    ...
                    <p>Webrefiner follows a standard procedure of using log files. These files log visitors when they
                    ...
                    <p>Like any other website, Webrefiner uses 'cookies'. These cookies are used to store information
                    ...
                    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons
                        that are used in their respective advertisements and links that appear on Webrefiner, which are
                    ...
                    <p>Note that Webrefiner has no access to or control over these cookies that are used by third-party
                        advertisers.</p>

                    <h2>Third Party Privacy Policies</h2>

                    <p>Webrefiner's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                    ...
                    <p>Webrefiner does not knowingly collect any Personal Identifiable Information from children under
